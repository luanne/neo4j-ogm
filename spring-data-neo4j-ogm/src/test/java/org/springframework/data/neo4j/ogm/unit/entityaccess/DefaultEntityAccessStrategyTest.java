package org.springframework.data.neo4j.ogm.unit.entityaccess;
...
import org.springframework.data.neo4j.ogm.domain.forum.activity.Comment;
import org.springframework.data.neo4j.ogm.domain.forum.activity.Post;
import org.springframework.data.neo4j.ogm.domain.satellites.Location;
import org.springframework.data.neo4j.ogm.domain.satellites.Program;
import org.springframework.data.neo4j.ogm.domain.satellites.Satellite;
import org.springframework.data.neo4j.ogm.entityaccess.*;
...
public class DefaultEntityAccessStrategyTest {
    ...
    private DomainInfo domainInfo = new DomainInfo("org.springframework.data.neo4j.ogm.unit.entityaccess",
            "org.springframework.data.neo4j.ogm.domain.forum", "org.springframework.data.neo4j.ogm.domain.satellites");
