package org.springframework.data.neo4j.ogm.unit.metadata;

import org.junit.Test;
import org.springframework.data.neo4j.ogm.domain.education.Student;
import org.springframework.data.neo4j.ogm.domain.forum.Member;
import org.springframework.data.neo4j.ogm.domain.forum.activity.Activity;
...
import org.springframework.data.neo4j.ogm.metadata.info.FieldInfo;
import org.springframework.data.neo4j.ogm.metadata.info.MethodInfo;
...
public class MetaDataTest {
    ...
    private static final MetaData metaData = new MetaData("org.springframework.data.neo4j.ogm.domain.forum", "org.springframework.data.neo4j.ogm.domain.canonical");
    ...
    public void testClassInfo() {
        assertEquals("org.springframework.data.neo4j.ogm.domain.forum.Topic", metaData.classInfo("Topic").name());
    }
    ...
    public void testAnnotatedClassInfo() {
        assertEquals("org.springframework.data.neo4j.ogm.domain.forum.Member", metaData.classInfo("User").name());
        assertEquals("org.springframework.data.neo4j.ogm.domain.forum.BronzeMembership", metaData.classInfo("Bronze").name());
    }
    ...
    public void testCanResolveRelationshipEntityFromRelationshipType() {
        ...
        assertEquals("org.springframework.data.neo4j.ogm.domain.canonical.ArbitraryRelationshipEntity", classInfo.name());
    }
    ...
    public void testResolutionOfRelationshipTypeFromMethodInfo() {
        ...
        assertNotNull("The resolved class info shouldn't be null", classInfo);
        assertEquals("org.springframework.data.neo4j.ogm.domain.forum.Forum", classInfo.name());
    ...
    public void testCanResolveClassHierarchies() {
        ...
        assertEquals("org.springframework.data.neo4j.ogm.domain.forum.Member", classInfo.name());
    }
    ...
    public void testClassInfoIsFoundForFQN() {
        String fqn = "org.springframework.data.neo4j.ogm.domain.forum.Topic";
    ...
    public void testOrderingOfTaxaIsUnimportant() {
        assertEquals("org.springframework.data.neo4j.ogm.domain.forum.BronzeMembership", metaData.resolve("Bronze", "Membership", "IMembership").name());
        assertEquals("org.springframework.data.neo4j.ogm.domain.forum.BronzeMembership", metaData.resolve("Bronze", "IMembership", "Membership").name());
        assertEquals("org.springframework.data.neo4j.ogm.domain.forum.BronzeMembership", metaData.resolve("Membership", "IMembership", "Bronze").name());
        assertEquals("org.springframework.data.neo4j.ogm.domain.forum.BronzeMembership", metaData.resolve("Membership", "Bronze", "IMembership").name());
        assertEquals("org.springframework.data.neo4j.ogm.domain.forum.BronzeMembership", metaData.resolve("IMembership", "Bronze", "Membership").name());
        assertEquals("org.springframework.data.neo4j.ogm.domain.forum.BronzeMembership", metaData.resolve("IMembership", "Membership", "Bronze").name());
    }

    @Test
    public void testLiskovSubstitutionPrinciple() {
        assertEquals("org.springframework.data.neo4j.ogm.domain.forum.Member", metaData.resolve("Member").name());
        assertEquals("org.springframework.data.neo4j.ogm.domain.forum.Member", metaData.resolve("Login", "Member").name());
    }
    ...
    public void testNonMemberAndMemberTaxa() {
        assertEquals("org.springframework.data.neo4j.ogm.domain.forum.SilverMembership", metaData.resolve("Silver", "Pewter", "Tin").name());
    }
    ...
    public void testLabelsForClassInfo() {
        ...
        ClassInfo nonAnnotatedClassInfo = new MetaData("org.springframework.data.neo4j.ogm.domain.education").classInfo(Student.class.getSimpleName());
