package org.springframework.data.neo4j.ogm.integration.cineasts.annotated;
...
import org.springframework.data.neo4j.ogm.domain.cineasts.annotated.Movie;
import org.springframework.data.neo4j.ogm.domain.cineasts.annotated.Rating;
import org.springframework.data.neo4j.ogm.domain.cineasts.annotated.User;
import org.springframework.data.neo4j.ogm.integration.IntegrationTest;
...
public class CineastsIntegrationTest extends IntegrationTest {
    ...
    public static void init() throws IOException {
        setUp();
        session = new SessionFactory("org.springframework.data.neo4j.ogm.domain.cineasts.annotated").openSession("http://localhost:" + neoPort);
        importCineasts();
    }

    private static void importCineasts() {
        session.execute(load("org.springframework.data.neo4j.ogm.cql/cineasts.cql"));
    }
