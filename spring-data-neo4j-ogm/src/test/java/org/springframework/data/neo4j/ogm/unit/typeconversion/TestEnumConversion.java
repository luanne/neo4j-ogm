...
import org.springframework.data.neo4j.ogm.domain.convertible.enums.*;
...
public class TestEnumConversion {
    ...
    private static final MetaData metaData = new MetaData("org.springframework.data.neo4j.ogm.domain.convertible.enums");
