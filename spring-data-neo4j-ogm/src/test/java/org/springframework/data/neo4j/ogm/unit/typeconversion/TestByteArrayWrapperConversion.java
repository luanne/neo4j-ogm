...
import org.springframework.data.neo4j.ogm.domain.convertible.bytes.PhotoWrapper;
...
public class TestByteArrayWrapperConversion {
    ...
    private static final MetaData metaData = new MetaData("org.springframework.data.neo4j.ogm.domain.convertible.bytes");
