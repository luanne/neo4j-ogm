...
import org.springframework.data.neo4j.ogm.domain.friendships.Friendship;
import org.springframework.data.neo4j.ogm.domain.friendships.Person;
...
public class RelationshipEntityHydrationTest extends IntegrationTest {
    ...
    public void init() throws IOException {
        setUp();
        sessionFactory = new SessionFactory("org.springframework.data.neo4j.ogm.domain.friendship");
