package org.springframework.data.neo4j.ogm.integration.hierarchy;
...
import org.springframework.data.neo4j.ogm.integration.hierarchy.domain.annotated.*;
import org.springframework.data.neo4j.ogm.integration.hierarchy.domain.people.*;
import org.springframework.data.neo4j.ogm.integration.hierarchy.domain.plain.*;
import org.springframework.data.neo4j.ogm.integration.hierarchy.domain.trans.*;
...
public class ClassHierarchiesIntegrationTest extends WrappingServerIntegrationTest {
    ...
    public void init() throws IOException {
        SessionFactory sessionFactory = new SessionFactory("org.springframework.data.neo4j.ogm.integration.hierarchy.domain");
    ...
    public void shouldFailWithConflictingHierarchies() {
        ...
        SessionFactory sessionFactory = new SessionFactory("org.springframework.data.neo4j.ogm.integration.hierarchy.domain", "org.springframework.data.neo4j.ogm.integration.hierarchy.conflicting");
        session = sessionFactory.openSession("http://localhost:" + 7896);
