package org.springframework.data.neo4j.ogm.unit.session.lifecycle;
...
public class StaleObjectTest extends LifecycleTest {
    ...
    public void init() throws IOException {
        ...
        sessionFactory = new SessionFactory("org.springframework.data.neo4j.ogm.domain.filesystem");
