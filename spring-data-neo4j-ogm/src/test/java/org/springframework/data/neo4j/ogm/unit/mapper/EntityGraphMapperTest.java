package org.springframework.data.neo4j.ogm.unit.mapper;
...
import org.springframework.data.neo4j.ogm.domain.education.Course;
import org.springframework.data.neo4j.ogm.domain.education.School;
import org.springframework.data.neo4j.ogm.domain.education.Student;
import org.springframework.data.neo4j.ogm.domain.education.Teacher;
import org.springframework.data.neo4j.ogm.domain.forum.Forum;
import org.springframework.data.neo4j.ogm.domain.forum.ForumTopicLink;
import org.springframework.data.neo4j.ogm.domain.forum.Topic;
import org.springframework.data.neo4j.ogm.domain.policy.Person;
import org.springframework.data.neo4j.ogm.domain.policy.Policy;
import org.springframework.data.neo4j.ogm.domain.social.Individual;
import org.springframework.data.neo4j.ogm.mapper.EntityGraphMapper;
import org.springframework.data.neo4j.ogm.mapper.EntityToGraphMapper;
import org.springframework.data.neo4j.ogm.mapper.MappedRelationship;
import org.springframework.data.neo4j.ogm.mapper.MappingContext;
...
public class EntityGraphMapperTest {
    ...
    public static void setUpTestDatabase() {
        ...
        mappingMetadata = new MetaData(
                "org.springframework.data.neo4j.ogm.domain.education",
                "org.springframework.data.neo4j.ogm.domain.forum",
                "org.springframework.data.neo4j.ogm.domain.social",
                "org.springframework.data.neo4j.ogm.domain.policy");
