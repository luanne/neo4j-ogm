...
import org.springframework.data.neo4j.ogm.domain.canonical.ArbitraryRelationshipEntity;
import org.springframework.data.neo4j.ogm.domain.social.Individual;
import org.springframework.data.neo4j.ogm.entityaccess.EntityFactory;
...
public class ObjectFactoryTest {
    ...
    @Before
    public void setUp() {
        this.objectCreator = new EntityFactory(new MetaData("org.springframework.data.neo4j.ogm.domain.social", "org.springframework.data.neo4j.ogm.domain.canonical"));
    }
