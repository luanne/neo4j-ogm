...
import org.springframework.data.neo4j.ogm.domain.convertible.numbers.Account;
...
public class TestNumberConversion {
    ...
    private static final MetaData metaData = new MetaData("org.springframework.data.neo4j.ogm.domain.convertible.numbers");
